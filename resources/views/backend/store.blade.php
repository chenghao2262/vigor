...
<section id="main-wrapper" class="theme-default">
    ...
    <section class="main-content-wrapper">
        <div class="pageheader">
            <h1>健货商城</h1>
            <p class="description">这里展示健身相关商品</p>
                            ...
                            <div class="tab-wrapper tab-primary">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <img src="/assets/img/vac-1.jpg" class="img-responsive">
                                ...
                                <div class="row">
                                    <div class="col-md-offset-2 col-md-8">
                                        <div class="row">   
                                            <div class="name">登山套装</div>    
                                        </div>
                                        <div class="row">   
                                            <p>登山活动中集体和个人所使用的专用装备、保障装备和日用装备</p>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-offset-6 col-md-4">
                                        <button type="button" class="btn btn-primary " onclick="">申请兑换</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="tab-wrapper tab-primary">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <img src="/assets/img/dive.png" class="img-responsive">
                            ...
                            <div class="tab-wrapper tab-primary">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <img src="/assets/img/skating.png" class="img-responsive">
                            ...
                            <div class="tab-wrapper tab-primary">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <img src="/assets/img/climb.png" class="img-responsive">
                            ...
                            <div class="tab-wrapper tab-primary">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <img src="/assets/img/cycle.png" class="img-responsive">
                            ...
                            <div class="tab-wrapper tab-primary">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <img src="/assets/img/jump.png" class="img-responsive">
